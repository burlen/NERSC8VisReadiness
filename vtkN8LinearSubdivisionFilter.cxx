/*=========================================================================
  ...
  Module:    vtkN8LinearSubdivisionFilter.cxx
...
vtkStandardNewMacro(vtkN8LinearSubdivisionFilter);

void vtkN8LinearSubdivisionFilter::GenerateSubdivisionPoints (vtkPolyData *inputDS, vtkIntArray *edgeData, vtkPoints *outputPts, vtkPointData *outputPD)
{
  vtkIdType *pts = 0;
  int edgeId;
