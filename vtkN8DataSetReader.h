...
=========================================================================*/
// .NAME vtkN8DataSetReader - class to read any type of vtk dataset
// .SECTION Description
// vtkN8DataSetReader is a class that provides instance variables and methods
...
#ifndef __vtkN8DataSetReader_h
#define __vtkN8DataSetReader_h
...
class VTKIOLEGACY_EXPORT vtkN8DataSetReader : public vtkDataReader
{
public:
  static vtkN8DataSetReader *New();
  vtkTypeMacro(vtkN8DataSetReader,vtkDataReader);
...
private:
  vtkN8DataSetReader(const vtkN8DataSetReader&);  // Not implemented.
  void operator=(const vtkN8DataSetReader&);  // Not implemented.
};
