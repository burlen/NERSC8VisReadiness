/*=========================================================================
  ...
  Module:    vtkN8TriangleFilter.cxx
...
vtkStandardNewMacro(vtkN8TriangleFilter);

int vtkN8TriangleFilter::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  if (globalLogLevel)
    {
    log->StartEvent("vtkN8TriangleFilter::RequestData");
    }
  ...
  if (globalLogLevel)
    {
    log->EndEvent("vtkN8TriangleFilter::RequestData");
    }

  return 1;
}

void vtkN8TriangleFilter::PrintSelf(ostream& os, vtkIndent indent)
{
