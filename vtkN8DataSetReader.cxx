...
vtkStandardNewMacro(vtkN8DataSetReader);

vtkN8DataSetReader::vtkN8DataSetReader()
{
}
...
int vtkN8DataSetReader::RequestDataObject(
  vtkInformation *,
...
int vtkN8DataSetReader::RequestInformation(
  vtkInformation *,
...
int vtkN8DataSetReader::RequestData(
  vtkInformation *,
  vtkInformationVector **,
  vtkInformationVector *outputVector)
{
  ...
  if (globalLogLevel)
    {
    log->StartEvent("vtkN8DataSetReader::RequestData");
    }
  ...
  if (globalLogLevel)
    {
    log->EndEvent("vtkN8DataSetReader::RequestData");
    }

  return 1;
}

int vtkN8DataSetReader::ReadOutputType()
{
  char line[256];
...
vtkPolyData *vtkN8DataSetReader::GetPolyDataOutput()
{
  return vtkPolyData::SafeDownCast(this->GetOutput());
}

vtkStructuredPoints *vtkN8DataSetReader::GetStructuredPointsOutput()
{
  return vtkStructuredPoints::SafeDownCast(this->GetOutput());
}

vtkStructuredGrid *vtkN8DataSetReader::GetStructuredGridOutput()
{
  return vtkStructuredGrid::SafeDownCast(this->GetOutput());
}

vtkUnstructuredGrid *vtkN8DataSetReader::GetUnstructuredGridOutput()
{
  return vtkUnstructuredGrid::SafeDownCast(this->GetOutput());
}

vtkRectilinearGrid *vtkN8DataSetReader::GetRectilinearGridOutput()
{
  return vtkRectilinearGrid::SafeDownCast(this->GetOutput());
}

void vtkN8DataSetReader::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}

vtkDataSet *vtkN8DataSetReader::GetOutput(int idx)
{
  return vtkDataSet::SafeDownCast(this->GetOutputDataObject(idx));
}

vtkDataSet *vtkN8DataSetReader::GetOutput()
{
  return vtkDataSet::SafeDownCast(this->GetOutputDataObject(0));
}

int vtkN8DataSetReader::FillOutputPortInformation(int, vtkInformation *info)
{
  info->Set(vtkDataObject::DATA_TYPE_NAME(), "vtkDataSet");
  return 1;
}

int vtkN8DataSetReader::ProcessRequest(vtkInformation* request,
