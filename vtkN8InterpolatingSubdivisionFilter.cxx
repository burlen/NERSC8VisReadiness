/*=========================================================================
  ...
  Module:    vtkN8InterpolatingSubdivisionFilter.cxx
...
vtkN8InterpolatingSubdivisionFilter::vtkN8InterpolatingSubdivisionFilter()
{
  this->NumberOfSubdivisions = 1;
}

int vtkN8InterpolatingSubdivisionFilter::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  if (globalLogLevel)
    {
    log->StartEvent("vtkN8InterpolatingSubdivisionFilter::RequestData");
    }
  ...
  if (globalLogLevel)
    {
    log->EndEvent("vtkN8InterpolatingSubdivisionFilter::RequestData");
    }

  return 1;
}

int vtkN8InterpolatingSubdivisionFilter::FindEdge (vtkPolyData *mesh,
                                                 vtkIdType cellId,
...
vtkIdType vtkN8InterpolatingSubdivisionFilter::InterpolatePosition (
...
void vtkN8InterpolatingSubdivisionFilter::GenerateSubdivisionCells (vtkPolyData *inputDS, vtkIntArray *edgeData, vtkCellArray *outputPolys, vtkCellData *outputCD)
{
...
void vtkN8InterpolatingSubdivisionFilter::PrintSelf(ostream& os, vtkIndent indent)
{
